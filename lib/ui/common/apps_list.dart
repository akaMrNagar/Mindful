...
class AnimatedAppsListOld extends ConsumerStatefulWidget {
  const AnimatedAppsListOld({
    super.key,
  ...
  final List<String> Function(List<String> apps)? manuallySortApps;
  final String? listLabel;

  @override
  ConsumerState<AnimatedAppsListOld> createState() => _AnimatedAppsListState();
}

class _AnimatedAppsListState extends ConsumerState<AnimatedAppsListOld> {
  ...
  Widget build(BuildContext context) {
    ...
    final params = (
      dayOfWeek: widget.selectedDoW,
      includeAll: _includeAllApps || widget.showAllApps
    );
      ...
      children: [
        ...
        sortedApps.when(
          ...
          data: (apps) {
            ...
            final packages = widget.manuallySortApps?.call(apps) ?? apps;
        ...
        if (sortedApps.hasValue && !_includeAllApps && !widget.showAllApps)
          RoundedContainer(
            height: 48,
