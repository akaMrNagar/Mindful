...
/// Animates the hero widget to a alert dialog to set app session and cooldown limit in seconds
///
/// Returns the entered session and cooldown time in SECONDS
Future<int?> showAppSessionLimitDialog({
      ...
      child: Container(
        ...
        child: SingleChildScrollView(
          child: DefaultHero(
            ...
            child: AlertDialog(
              scrollable: true,
              icon: const Icon(FluentIcons.shifts_availability_20_filled),
              ...
              content: Container(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      StyledText("Spend the following time in single session"),
                      32.vBox,
                      Container(
                        height: 96,
                        ...
                        child: CupertinoTimerPicker(
                          ...
                          initialTimerDuration: 500.seconds,
                          onTimerDurationChanged: (val) {},
                        ),
                      ),
                      const StyledText("then to open again wait for "),
                      Container(
                        height: 96,
                        margin: const EdgeInsets.symmetric(vertical: 12),
                        child: CupertinoTimerPicker(
                          itemExtent: 32,
                          mode: CupertinoTimerPickerMode.hm,
                          initialTimerDuration: 200.seconds,
                          onTimerDurationChanged: (val) {},
                        ),
                      ),
                    ],
