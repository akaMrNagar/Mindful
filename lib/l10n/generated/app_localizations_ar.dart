...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get permission_sheet_privacy_info => 'تطبيق Mindful آمن بنسبة ١٠٠% ويعمل دون اتصال بالإنترنت. ولا نقوم بجمع أو تخزين أي بيانات شخصية.';
  ...
  @override
  String get permission_grant_step_three => '٣. انقر فوق المفتاح وقم بتشغيله كما هو موضح أدناه.';
  ...
  @override
  String get permission_alarms_info => 'يرجى منح الإذن لضبط التنبيهات والتذكيرات. سيسمح هذا لتطبيق Mindful ببدء جدول وقت النوم في الوقت المحدد وإعادة ضبط مؤقتات التطبيق يوميًا عند منتصف الليل ومساعدتك على البقاء على المسار الصحيح.';

  @override
  String get permission_alarms_device_tile_label => 'السماح بإعداد التنبيهات والتذكيرات';

  @override
  String get permission_usage_title => 'الوصول إلى الاستخدام';

  @override
  String get permission_usage_info => 'يرجى منح إذن الوصول إلى الاستخدام. سيسمح هذا لـ Mindful بمراقبة استخدام التطبيق وإدارة الوصول إلى تطبيقات معينة، مما يضمن بيئة رقمية أكثر تركيزًا وتحكمًا.';

  @override
  String get permission_usage_device_tile_label => 'السماح بالوصول إلى الاستخدام';

  @override
  String get permission_overlay_title => 'عرض التراكب';

  @override
  String get permission_overlay_info => 'يرجى منح إذن عرض التراكب. سيسمح هذا لتطبيق Mindful بعرض تراكب عند فتح تطبيق متوقف مؤقتًا، مما يساعدك على البقاء مركزًا والالتزام بجدولك الزمني.';

  @override
  String get permission_overlay_device_tile_label => 'السماح بالعرض على التطبيقات الأخرى';

  @override
  String get permission_accessibility_title => 'إمكانية الوصول';

  @override
  String get permission_accessibility_info => 'يرجى منح إذن الوصول. سيسمح هذا لشركة Mindful بتقييد الوصول إلى محتوى الفيديو القصير (مثل Reels وShorts) داخل تطبيقات الوسائط الاجتماعية والمتصفحات، وتصفية المواقع الإلكترونية غير المناسبة.';
  ...
  @override
  String get permission_dnd_info => 'يرجى منح ميزة \"عدم الإزعاج\" حق الوصول. سيسمح هذا لتطبيق Mindful ببدء وإيقاف وضع \"عدم الإزعاج\" أثناء جدول وقت النوم.';
  ...
  @override
  String get permission_battery_optimization_tile_title => 'تجاهل تحسين البطارية';

  @override
  String get permission_battery_optimization_status_enabled => 'غير مقيد بالفعل';

  @override
  String get permission_battery_optimization_status_disabled => 'تعطيل تقييد الخلفية';

  @override
  String get permission_battery_optimization_allow_info => 'سيؤدي السماح بـ \"تجاهل تحسين البطارية\" إلى منح إذن \"التنبيهات والتذكيرات\" تلقائيًا على بعض الأجهزة';

  @override
  String get permission_vpn_title => 'إنشاء VPN';

  @override
  String get permission_vpn_info => 'يرجى منح الإذن لإنشاء اتصال بشبكة خاصة افتراضية (VPN). سيسمح هذا لـ Mindful بتقييد الوصول إلى الإنترنت للتطبيقات المحددة من خلال إنشاء شبكة VPN محلية على الجهاز.';

  @override
  String get permission_admin_title => 'مسؤول';

  @override
  String get permission_admin_info => 'تكون الامتيازات الإدارية ضرورية فقط للعمليات الأساسية لضمان عمل التطبيق بشكل صحيح وبقائه مقاومًا للتلاعب.';

  @override
  String get permission_admin_snack_alert => 'لا يمكن تعطيل الحماية من العبث إلا خلال فترة زمنية محددة.';

  @override
  String get permission_notification_access_title => 'الوصول إلى الإشعارات';

  @override
  String get permission_notification_access_info => 'يرجى منح إذن الوصول إلى الإشعارات. سيسمح هذا لـ Mindful بتنظيم إشعاراتك وتسليمها حسب جدولك.';

  @override
  String get permission_notification_access_required => 'يتطلب Mindful الوصول إلى الإشعارات للدفعات والإشعارات المجدولة.';

  @override
  String get permission_notification_access_device_tile_label => 'السماح بالوصول إلى الإشعارات';
  ...
  @override
  String get development_dialog_info => 'تطبيق Mindful قيد التطوير حاليًا وقد يحتوي على أخطاء أو ميزات غير مكتملة. إذا واجهت أي مشكلات، فيرجى الإبلاغ عنها لمساعدتنا على التحسين.\n\nشكرًا لك على ملاحظاتك!';
  ...
  @override
  String get dnd_settings_tile_subtitle => 'إدارة التطبيقات والإشعارات التي يمكنها الوصول إليك في وضع عدم الإزعاج.';

  @override
  String get quick_actions_heading => 'الإجراءات السريعة';

  @override
  String get select_distracting_apps_heading => 'حدد التطبيقات المشتتة للانتباه';
  ...
  @override
  String get imp_distracting_apps_snack_alert => 'لا يُسمح بإضافة تطبيقات النظام المهمة إلى قائمة التطبيقات المشتتة للانتباه.';

  @override
  String get custom_apps_quick_actions_unavailable_warning => 'لا يتوفر استخدام الشاشة والقيود لهذا التطبيق. في الوقت الحالي، يمكن الوصول إلى استخدام الشبكة فقط';

  @override
  String get create_group_fab_button => 'إنشاء مجموعة';

  @override
  String get active_period_info => 'حدد مدّة زمنية يُسمح خلالها بالوصول. وخارج هذه المدّة الزمنية، سيتم تقييد الوصول.';

  @override
  String get minimum_distracting_apps_snack_alert => 'حدد تطبيقًا واحدًا علي الأقل يشتت انتباهك.';

  @override
  String get donation_card_title => 'ادعمنا';

  @override
  String get donation_card_info => 'Mindful هو تطبيق مجاني ومفتوح المصدر، تم تطويره بعد شهور من التفاني. إذا ساعدك التطبيق، فإن تبرعك يعني الكثير بالنسبة لنا. تساعدنا كل مساهمة في تحسينه وصيانته من أجل الجميع.';
  ...
  @override
  String get app_restart_dialog_info => 'سيتم إعادة تشغيل Mindful تلقائيًا بمجرد انتهاء العد التنازلي. يرجى التحلي بالصبر أثناء تطبيق التغييرات.';
  ...
  @override
  String get onboarding_page_one_info => 'قم بإيقاف التطبيقات المشتتة للانتباه مؤقتًا، وحظر المحتوى القصير، والتزم بالمسار الصحيح من خلال جلسات التركيز القابلة للتخصيص. سواء كنت تعمل أو تدرس أو تسترخي، يساعدك Mindful على البقاء متحكمًا.';

  @override
  String get onboarding_page_two_title => 'منع التشتيتات.';

  @override
  String get onboarding_page_two_info => 'قم بتعيين حدود الاستخدام وإيقاف التطبيقات تلقائيًا وإنشاء عادات رقمية أكثر صحة. استخدم وضع وقت النوم للاسترخاء والاستمتاع بليلة خالية من التشتيت.';

  @override
  String get onboarding_page_three_title => 'الخصوصية أولاً.';

  @override
  String get onboarding_page_three_info => 'Mindful هو تطبيق مفتوح المصدر بنسبة ١٠٠% ويعمل دون اتصال بالإنترنت بالكامل. نحن لا نجمع أو نشارك بياناتك الشخصية — خصوصيتك مضمونة بكل الطرق.';

  @override
  String get onboarding_page_permissions_title => 'الأذونات الأساسية.';

  @override
  String get onboarding_page_permissions_info => 'يتطلب Mindful اتباع الأذونات الأساسية لتتبع وإدارة وقت الشاشة، مما يساعد على تقليل عوامل التشتيت وتحسين التركيز.';
  ...
  @override
  String get username_dialog_info => 'أدخل أسم المستخدم الخاص بك والذي سيتم عرضه على لوحة التحكم.';
