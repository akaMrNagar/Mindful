...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get permission_sheet_privacy_info => 'Mindful est 100% sécurisé et fonctionne hors ligne. Nous ne collectons ni stockons aucune donnée personnelle.';
  ...
  @override
  String get permission_grant_step_two => '2. Sélectionnez Mindful sur l\'écran suivant.';

  @override
  String get permission_grant_step_three => '3. Cliquez sur le bouton et activez-le comme ci-dessous.';
  ...
  @override
  String get permission_alarms_info => 'Veuillez accorder la permission de régler les alarmes et les rappels. Cela permettra à Mindful de démarrer votre horaire de coucher à l\'heure, de réinitialiser les minuteurs de l\'application tous les jours à minuit et de vous aider à rester sur la bonne voie.';

  @override
  String get permission_alarms_device_tile_label => 'Autoriser à définir des alarmes et des rappels';

  @override
  String get permission_usage_title => 'Accès aux données d\'utilisation';

  @override
  String get permission_usage_info => 'Veuillez accorder l\'autorisation d\'accès aux données d\'utilisation. Cela permettra à Mindful de surveiller l\'utilisation des applications et de gérer l\'accès à certaines applications, pour un environnement numérique plus contrôlé et propice à la concentration.';

  @override
  String get permission_usage_device_tile_label => 'Autoriser l\'accès aux données d\'utilisation';

  @override
  String get permission_overlay_title => 'Afficher la superposition';

  @override
  String get permission_overlay_info => 'Veuillez accorder la permission d\'afficher la superposition. Cela permettra à Mindful d\'afficher une surcouche quand une application en pause est ouverte, ce qui vous aidera à rester concentré et à maintenir votre planning.';

  @override
  String get permission_overlay_device_tile_label => 'Autoriser la superposition sur d\'autres applis';

  @override
  String get permission_accessibility_title => 'Accessibilité';

  @override
  String get permission_accessibility_info => 'Veuillez accorder l\'autorisation d\'accessibilité. Cela permettra à Mindful de restreindre l\'accès au contenu vidéo court (ex : Reels, Shorts) dans les applications de réseaux sociaux et les navigateurs, et filtrer les sites Web inappropriés.';
  ...
  @override
  String get permission_dnd_info => 'Veuillez autoriser l\'accès au mode Ne pas déranger. Cela permettra à Mindful de démarrer et d\'arrêter le mode Ne pas déranger pendant l\'horaire du sommeil.';

  @override
  String get permission_dnd_tile_title => 'Lancer Ne pas déranger';

  @override
  String get permission_dnd_tile_subtitle => 'Activer aussi le mode Ne pas déranger.';

  @override
  String get permission_battery_optimization_tile_title => 'Désactiver l\'optimisation de la batterie';

  @override
  String get permission_battery_optimization_status_enabled => 'Déjà non restreint';

  @override
  String get permission_battery_optimization_status_disabled => 'Désactiver la restriction d\'arrière-plan';

  @override
  String get permission_battery_optimization_allow_info => 'Autoriser la désactivation de l\'optimisation de la batterie accordera automatiquement la permission \'Alarmes & Rappels\' sur certains appareils.';

  @override
  String get permission_vpn_title => 'Créer un VPN';

  @override
  String get permission_vpn_info => 'Veuillez accorder la permission de créer une connexion au réseau privé virtuel (VPN). Cela permettra à Mindful de restreindre l\'accès à Internet pour les applications désignées en créant un VPN local sur le périphérique.';

  @override
  String get permission_admin_title => 'Admin';

  @override
  String get permission_admin_info => 'Les privilèges d\'administration ne sont nécessaires que pour les opérations essentielles afin de s\'assurer que l\'application fonctionne correctement et reste protégée contre les modifications.';

  @override
  String get permission_admin_snack_alert => 'La protection contre les modifications ne peut être désactivée que dans la plage horaire sélectionnée.';

  @override
  String get permission_notification_access_title => 'Accès aux notifications';

  @override
  String get permission_notification_access_info => 'Veuillez accorder l\'autorisation d\'accès aux notifications. Cela permettra à Mindful d\'organiser vos notifications et de les envoyer selon votre planning.';

  @override
  String get permission_notification_access_required => 'Mindful nécessite un accès aux notifications pour regrouper et planifier les notifications.';

  @override
  String get permission_notification_access_device_tile_label => 'Autoriser l\'accès aux notifications';
  ...
  @override
  String get development_dialog_info => 'Mindful est actuellement en cours de développement et peut avoir des bugs ou des fonctionnalités incomplètes. Si vous rencontrez des problèmes, merci de les signaler pour nous aider à nous améliorer.\n\nMerci pour vos retours !';
  ...
  @override
  String get dnd_settings_tile_subtitle => 'Gérer quelles apps et notifications peuvent vous solliciter dans le mode Ne pas déranger.';

  @override
  String get quick_actions_heading => 'Actions rapides';

  @override
  String get select_distracting_apps_heading => 'Sélectionner les apps qui vous distraient';
  ...
  @override
  String get imp_distracting_apps_snack_alert => 'L\'ajout d\'applications système importantes à la liste des applications qui vous déconcentrent n\'est pas autorisé.';

  @override
  String get custom_apps_quick_actions_unavailable_warning => 'Le temps d\'écran et les restrictions ne sont pas disponibles pour cette application. Pour l\'instant, seulement la consommation de données est disponible';

  @override
  String get create_group_fab_button => 'Créer un groupe';

  @override
  String get active_period_info => 'Définissez une période pendant laquelle l\'accès sera autorisé. En dehors de cette période, l\'accès sera restreint.';

  @override
  String get minimum_distracting_apps_snack_alert => 'Sélectionnez au moins une app qui vous distrait.';

  @override
  String get donation_card_title => 'Soutenez-nous';

  @override
  String get donation_card_info => 'Mindful est une application gratuite et open-source, développée avec dévouement durant des mois. Si elle vous a aidé, votre don signifierait beaucoup pour nous. Chaque don nous permet de continuer à l\'améliorer et la maintenir pour tous.';

  @override
  String get operation_failed_snack_alert => 'L\'opération a échoué, une erreur s\'est produite !';
  ...
  @override
  String get app_restart_dialog_info => 'Mindful redémarrera automatiquement à la fin du compte à rebours. Merci de patienter le temps que les modifications soient appliquées.';
  ...
  @override
  String get onboarding_page_two_info => 'Définissez des limites d\'utilisation, mettez automatiquement en pause les applications et créez des habitudes numériques plus saines. Utilisez le mode temps de sommeil pour vous détendre et profiter d\'une nuit sans distraction.';

  @override
  String get onboarding_page_three_title => 'Confidentialité avant tout.';

  @override
  String get onboarding_page_three_info => 'Mindful est 100% open-source et fonctionne entièrement hors ligne. Nous ne collectons ni ne partageons pas vos données personnelles — votre vie privée est garantie à tous les niveaux.';

  @override
  String get onboarding_page_permissions_title => 'Permissions indispensables.';

  @override
  String get onboarding_page_permissions_info => 'Mindful a besoin des autorisations suivantes pour suivre et gérer votre temps d\'écran, vous aider à réduire les distractions et améliorer votre concentration.';
  ...
  @override
  String get username_snack_alert => 'Appuyez longuement pour modifier le nom d\'utilisateur.';

  @override
  String get username_dialog_title => 'Nom d’utilisateur';

  @override
  String get username_dialog_info => 'Entrez le nom d\'utilisateur qui s\'affichera sur le tableau de bord.';
  ...
  @override
  String get new_schedule_dialog_info => 'Entrez un nom pour l\'horaire de notification pour l\'identifier facilement.';
  ...
  @override
  String get bedtime_tab_info => 'Fixer l\'heure du coucher en sélectionnant une période et des jours de la semaine. Choisissez les applications qui vous distraient à bloquer et activer le mode Ne pas déranger pour une nuit paisible.';

  @override
  String get schedule_tile_title => 'Planifier';

  @override
  String get schedule_tile_subtitle => 'Activer ou désactiver la planification quotidienne.';

  @override
  String get bedtime_no_days_selected_snack_alert => 'Sélectionnez au moins un jour de la semaine.';

  @override
  String get bedtime_minimum_duration_snack_alert => 'La durée totale du temps de sommeil doit être d\'au moins 30 min.';

  @override
  String get distracting_apps_tile_title => 'Apps qui vous distraient';

  @override
  String get distracting_apps_tile_subtitle => 'Sélectionnez les applications qui vous distraient de votre routine du coucher.';
  ...
  @override
  String get invincible_mode_snack_alert => 'En raison du mode invincible, les modifications des restrictions ne sont pas autorisées.';

  @override
  String get invincible_mode_dialog_info => 'Êtes-vous absolument sûr de vouloir activer le Mode Invincible ? Cette action est irréversible. Une fois que le Mode Invincible est activé, vous ne pouvez pas le désactiver tant que cette application est installée sur votre appareil.';

  @override
  String get invincible_mode_turn_off_snack_alert => 'Le mode invincible ne peut pas être désactivé tant que cette application reste installée sur votre appareil.';

  @override
  String get invincible_mode_dialog_button_start_anyway => 'Démarrer quand même';

  @override
  String get invincible_mode_include_timer_tile_title => 'Include timer';

  @override
  String get invincible_mode_include_launch_limit_tile_title => 'Inclure la limite de lancement';

  @override
  String get invincible_mode_include_active_period_tile_title => 'Include active period';

  @override
  String get invincible_mode_app_restrictions_tile_title => 'Restrictions d\'applications';

  @override
  String get invincible_mode_app_restrictions_tile_subtitle => 'Empêcher toute modification des restrictions de l\'application sélectionnée une fois les limites quotidiennes dépassées.';

  @override
  String get invincible_mode_group_restrictions_tile_title => 'Restrictions groupées';

  @override
  String get invincible_mode_group_restrictions_tile_subtitle => 'Empêcher toute modification des restrictions de du groupe d\'applications sélectionné une fois les limites quotidiennes dépassées.';

  @override
  String get invincible_mode_include_shorts_timer_tile_title => 'Inclure les temps de contenus courts';

  @override
  String get invincible_mode_include_shorts_timer_tile_subtitle => 'Empêcher toute modification une fois votre limite quotidienne de contenus courts dépassée.';

  @override
  String get invincible_mode_include_bedtime_tile_title => 'Inclure le temps de sommeil';
  ...
  @override
  String get block_nsfw_subtitle => 'Empêcher les navigateurs d\'ouvrir des sites pour adultes et pornographiques.';

  @override
  String get block_nsfw_dialog_info => 'Êtes-vous sûr(e) ? Cette action est irréversible. Une fois que le bloqueur de sites pour adultes est activé, vous ne pouvez pas le désactiver tant que cette application est installée sur votre appareil.';
  ...
  @override
  String get add_website_dialog_info => 'Entrez l\'Url d\'un site web que vous voulez bloquer.';
  ...
  @override
  String get add_website_already_exist_snack_alert => 'L\'URL a déjà été ajouté à la liste des sites web bloqués.';

  @override
  String get add_website_invalid_url_snack_alert => 'URL invalide ! Impossible d\'analyser le nom d\'hôte.';
  ...
  @override
  String get focus_tab_info => 'Lorsque vous avez besoin de temps pour vous concentrer, démarrez une nouvelle session en sélectionnant le type, en choisissant les applications à mettre en pause, et en activant le mode Ne pas déranger pour une concentration ininterrompue.';

  @override
  String get active_session_card_title => 'Session active';

  @override
  String get active_session_card_info => 'Vous avez une session de concentration active en cours ! Cliquez sur \'Voir\' pour vérifier votre progression et voir combien de temps s\'est écoulé.';

  @override
  String get active_session_card_view_button => 'Voir';

  @override
  String get focus_distracting_apps_removal_snack_alert => 'La suppression d\'applications de la liste des applications qui vous distraient n\'est pas autorisée tant qu\'une session de concentration est active. Cependant, vous pouvez toujours ajouter des applications supplémentaires à la liste pendant cette période.';
  ...
  @override
  String get focus_session_duration_tile_subtitle => 'Infini (jusqu\'à ce que vous l\'arrêtiez)';

  @override
  String get focus_session_duration_dialog_info => 'Veuillez sélectionner la durée souhaitée pour cette session de concentration, en déterminant la durée pendant laquelle vous souhaitez rester concentré et sans distraction.';
  ...
  @override
  String get focus_session_start_fab_button => 'Démarrer la session';

  @override
  String get focus_session_minimum_apps_snack_alert => 'Sélectionnez au moins une application qui vous distrait pour démarrer la session de concentration';

  @override
  String get focus_session_already_active_snack_alert => 'Vous avez déjà une session de concentration active en cours d\'exécution. Veuillez terminer ou arrêter votre session actuelle avant d\'en commencer une nouvelle.';
  ...
  @override
  String get restriction_group_name_picker_dialog_info => 'Entrez un nom pour le groupe de restriction afin de l\'identifier et de le gérer facilement.';

  @override
  String get restriction_group_timer_tile_title => 'Minuteur pour le groupe';

  @override
  String get restriction_group_timer_picker_dialog_info => 'Définissez une limite de temps quotidienne pour ce groupe. Une fois votre limite atteinte, toutes les applications de ce groupe seront suspendues jusqu\'à minuit.';

  @override
  String get restriction_group_active_period_tile_title => 'Période d\'activité du groupe';
  ...
  @override
  String get restriction_group_invalid_limits_snack_alert => 'Définissez une limite de temps ou une limite de période d\'activité.';
  ...
  @override
  String get emergency_started_snack_alert => 'Le bloqueur d\'application est suspendu et reprendra le blocage dans 5 minutes.';

  @override
  String get emergency_already_active_snack_alert => 'Le bloqueur de l\'application est actuellement suspendu ou inactif. Si les notifications sont activées, vous recevrez informations concernant le temps restant.';

  @override
  String get emergency_no_pass_left_snack_alert => 'Vous avez utilisé tous vos délais d\'urgence. Les applications bloquées resteront bloquées jusqu\'à minuit, ou la session de concentration active se termine.';
  ...
  @override
  String get app_timer_picker_dialog_info => 'Définissez une limite de temps quotidienne pour cette application. Une fois votre limite atteinte, l\'application sera suspendue jusqu\'à minuit.';
  ...
  @override
  String get app_launch_limit_picker_dialog_info => 'Définissez combien de fois vous pouvez ouvrir cette application chaque jour. Une fois la limite atteinte, elle sera suspendue jusqu\'à minuit.';
  ...
  @override
  String get internet_access_tile_subtitle => 'Désactivez pour bloquer Internet pour l\'app.';
