...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get permission_sheet_privacy_info => 'O Mindful é 100% seguro e funciona offline. Não recolhemos nem armazenamos quaisquer dados pessoais.';
  ...
  @override
  String get permission_grant_step_two => '2. Selecione Mindful na próxima tela.';
  ...
  @override
  String get permission_alarms_info => 'Por favor, conceda permissão para definir alarmes e lembretes. Isso permitirá que o Mindful inicie sua programação de hora de dormir a tempo e redefina os cronômetros do aplicativo diariamente à meia-noite e ajude você a ficar no caminho certo.';

  @override
  String get permission_alarms_device_tile_label => 'Autorizar a definição de alarmes e lembretes';

  @override
  String get permission_usage_title => 'Acesso ao uso';

  @override
  String get permission_usage_info => 'Por favor, conceda permissão de acesso ao uso. Isso permitirá que a Mindful monitore o uso de aplicativos e gerencie o acesso a determinados aplicativos, garantindo um ambiente digital mais focado e controlado.';
  ...
  @override
  String get permission_overlay_info => 'Por favor, conceda permissão de sobreposição de tela. Isso permitirá que o Mindful mostre uma sobreposição quando um aplicativo pausado é aberto, ajudando você a manter o foco e manter sua agenda.';

  @override
  String get permission_overlay_device_tile_label => 'Permitir a exibição em outros aplicativos';

  @override
  String get permission_accessibility_title => 'Acessibilidade';

  @override
  String get permission_accessibility_info => 'Por favor, conceda permissão de acessibilidade. Isso permitirá que o Mindful restrinja o acesso ao conteúdo de vídeo curto (por exemplo, Reels, Shorts) dentro dos aplicativos e navegadores de mídia social e filtre sites inadequados.';
  ...
  @override
  String get permission_dnd_info => 'Por favor, conceda acesso a Não Perturbe. Isso permitirá que o Mindful inicie e pare o modo Não Perturbe durante a programação da hora de dormir.';
  ...
  @override
  String get permission_battery_optimization_tile_title => 'Ignorar a otimização de bateria';

  @override
  String get permission_battery_optimization_status_enabled => 'Já irrestrito';

  @override
  String get permission_battery_optimization_status_disabled => 'Desativar restrição em segundo plano';

  @override
  String get permission_battery_optimization_allow_info => 'Permitir \'Ignorar otimização da bateria\' automaticamente concede a permissão de \'Alarmes & Lembretes\' em alguns dispositivos.';

  @override
  String get permission_vpn_title => 'Criar uma VPN';

  @override
  String get permission_vpn_info => 'Por favor, conceda permissão para criar uma conexão de rede privada virtual (VPN). Isso permitirá que o Mindful restrinja o acesso à internet para aplicativos designados, criando uma VPN local no dispositivo.';
  ...
  @override
  String get permission_notification_access_info => 'Conceda permissão de acesso à notificação. Isso permitirá que Mindful  organize suas notificações e leva-las em sua agenda.';
  ...
  @override
  String get permission_notification_access_device_tile_label => 'Permite acesso à notificação';
  ...
  @override
  String get development_dialog_info => 'Mindful está atualmente em desenvolvimento e pode ter bugs ou recursos incompletos. Se você encontrar algum problema, por favor informe-os para nos ajudar a melhorar. Obrigado pelo seu feedback!';
  ...
  @override
  String get dnd_settings_tile_subtitle => 'Gerencie quais aplicativos e notificações podem te notificar no modo DND.';

  @override
  String get quick_actions_heading => 'Ações rápidas';

  @override
  String get select_distracting_apps_heading => 'Selecione os aplicativos que te distraem';
  ...
  @override
  String get imp_distracting_apps_snack_alert => 'Adicionar aplicativos do sistema importantes à lista de aplicativos que distraem não é permitido.';
  ...
  @override
  String get minimum_distracting_apps_snack_alert => 'Selecione pelo menos um aplicativo de distração';

  @override
  String get donation_card_title => 'Nos apoie';

  @override
  String get donation_card_info => 'Mindful é de graça e de código aberto, desenvolvido com meses de dedicação. Se isso ajudou você, sua doação significaria o mundo para nós. Toda contribuição nos ajudam continuar melhorando e revisando isso para todos.';

  @override
  String get operation_failed_snack_alert => 'Falha na operação, algo deu errado!';
  ...
  @override
  String get onboarding_page_one_info => 'Pause apps que distraem, bloqueie conteúdo curto e mantenha-se no caminho certo com sessões de foco personalizáveis. Se você está trabalhando, estudando ou relaxando, Mindful ajuda você a ficar no controle.';

  @override
  String get onboarding_page_two_title => 'Bloquear Distrações.';

  @override
  String get onboarding_page_two_info => 'Defina limites de uso, pause automaticamente os aplicativos e crie hábitos digitais mais saudáveis. Use o modo Hora de dormir para relaxar e desfrutar de uma noite livre de distrações.';

  @override
  String get onboarding_page_three_title => 'Privacidade em primeiro lugar.';

  @override
  String get onboarding_page_three_info => 'A Mindful é 100% open-source e opera totalmente offline. Não recolhemos nem partilhamos os seus dados pessoais — a sua privacidade está garantida de todas as formas.';

  @override
  String get onboarding_page_permissions_title => 'Permissões Essenciais.';

  @override
  String get onboarding_page_permissions_info => 'O Mindful requer as seguintes permissões essenciais para rastrear e gerenciar seu tempo de tela, ajudando a reduzir distrações e melhorar o foco.';
  ...
  @override
  String get username_dialog_info => 'Digite seu nome de usuário que será exibido no painel.';
  ...
  @override
  String get bedtime_tab_info => 'Defina o seu horário de dormir, selecionando um período e dias da semana. Escolha apps de distração para bloquear e ativar o modo Não Perturbe (DND) para uma noite tranquila.';

  @override
  String get schedule_tile_title => 'Agendar';

  @override
  String get schedule_tile_subtitle => 'Ativar ou desativar agendamento diário.';

  @override
  String get bedtime_no_days_selected_snack_alert => 'Selecione pelo menos um dia da semana.';

  @override
  String get bedtime_minimum_duration_snack_alert => 'A duração total do tempo de dormir deve ser de pelo menos 30 minutos.';

  @override
  String get distracting_apps_tile_title => 'Aplicativos distrativos';

  @override
  String get distracting_apps_tile_subtitle => 'Selecione quais aplicativos estão distraindo você de sua rotina de dormir.';

  @override
  String get bedtime_distracting_apps_modify_snack_alert => 'Modificações na lista de aplicativos distrativos não são permitidas enquanto o horário de dormir estiver ativo.';
  ...
  @override
  String get invincible_mode_dialog_info => 'Tem certeza de que deseja ativar o modo Invencível? Esta ação é irreversível. Visto que o modo invencível está ligado, você não pode desligá-lo enquanto este aplicativo estiver instalado no seu dispositivo.';
  ...
  @override
  String get invincible_mode_dialog_button_start_anyway => 'Iniciar mesmo assim';

  @override
  String get invincible_mode_include_timer_tile_title => 'Incluir cronômetro';

  @override
  String get invincible_mode_include_launch_limit_tile_title => 'Incluir limite de inicialização';

  @override
  String get invincible_mode_include_active_period_tile_title => 'Incluir período ativo';

  @override
  String get invincible_mode_app_restrictions_tile_title => 'Restrições do aplicativo';
  ...
  @override
  String get invincible_mode_group_restrictions_tile_title => 'Restrições de grupo';
  ...
  @override
  String get invincible_mode_include_shorts_timer_tile_title => 'Incluir temporizador curto';

  @override
  String get invincible_mode_include_shorts_timer_tile_subtitle => 'Prevents changes after reaching your daily shorts limit.';

  @override
  String get invincible_mode_include_bedtime_tile_title => 'Incluir horário de dormir';
  ...
  @override
  String get protected_access_tile_subtitle => 'Proteja Mindful com o bloqueio do seu dispositivo.';
  ...
  @override
  String get block_nsfw_subtitle => 'Restringir que navegadores abram sites adultos e pornográficos.';

  @override
  String get block_nsfw_dialog_info => 'Tem certeza? Esta ação é irreversível. Uma vez que o bloqueador de sites para adultos está ligado, você não pode desligá-lo enquanto este aplicativo estiver instalado no seu dispositivo.';
  ...
  @override
  String get blocked_websites_empty_list_hint => 'Clique no botão \'+ Adicionar Site\' para adicionar sites que você deseja bloquear.';
  ...
  @override
  String get add_website_dialog_info => 'Digite o URL de um site que você deseja bloquear.';
  ...
  @override
  String get add_website_already_exist_snack_alert => 'O URL já foi adicionado à lista de sites bloqueados.';

  @override
  String get add_website_invalid_url_snack_alert => 'URL inválido! Não foi possível analisar o nome do host.';
  ...
  @override
  String get focus_tab_info => 'Quando precisar de tempo para se concentrar, inicie uma nova sessão selecionando o tipo, escolhendo apps distrativos para pausar e ativando a opção Não perturbar para uma concentração ininterrupta.';

  @override
  String get active_session_card_title => 'Sessão ativa';

  @override
  String get active_session_card_info => 'Você tem uma sessão de foco ativo em execução! Clique em \'Ver\' para verificar o seu progresso e ver quanto tempo se passou.';

  @override
  String get active_session_card_view_button => 'Exibir';

  @override
  String get focus_distracting_apps_removal_snack_alert => 'Não é permitido remover aplicativos da lista de aplicativos distrativos enquanto uma sessão de foco estiver ativa. No entanto, você ainda pode adicionar aplicativos adicionais à lista durante esse período.';
  ...
  @override
  String get focus_session_duration_tile_subtitle => 'Infinito (A menos que você pare)';
  ...
  @override
  String get focus_session_start_fab_button => 'Iniciar sessão';

  @override
  String get focus_session_minimum_apps_snack_alert => 'Selecione pelo menos um aplicativo de distração para iniciar a sessão de foco';

  @override
  String get focus_session_already_active_snack_alert => 'Você já tem uma sessão de foco ativa em execução. Por favor, complete ou pare a sua sessão atual antes de iniciar uma nova.';
  ...
  @override
  String get focus_session_type_skillDevelopment => 'Desenvolvimento de Habilidades';
  ...
  @override
  String get your_sessions_empty_list_hint => 'Nenhuma sessão de foco registrada para o dia selecionado.';
  ...
  @override
  String get active_session_finish_dialog_info => 'Mantenha-se forte! Você está construindo um foco valioso. Tem certeza que você quer terminar essa sessão de foco? Todo momento extra conta para seus objetivos';

  @override
  String get active_session_giveup_dialog_title => 'Desistir';

  @override
  String get active_session_giveup_dialog_info => 'Espere! Você está quase lá não desista agora! Tem certeza que quer terminar esta sessão de foco mais cedo? O progresso será perdido.';
  ...
  @override
  String get active_session_giveup_snack_alert => 'Você desistiu! Não se preocupe, você pode fazer melhor da próxima vez. Cada esforço conta — apenas continue';

  @override
  String get active_session_quote_one => 'Cada passo conta, fique forte e continue!';

  @override
  String get active_session_quote_two => 'Fique focado! Você está fazendo um progresso incrível!';

  @override
  String get active_session_quote_three => 'Você está esmagando! Mantenha o ritmo!';

  @override
  String get active_session_quote_four => 'Só mais um pouco, você está indo muito bem!';
  ...
  @override
  String get restriction_group_name_picker_dialog_info => 'Digite um nome para os grupos restringidos para ajudar a identificar e gerenciá-los facilmente.';

  @override
  String get restriction_group_timer_tile_title => 'Temporizador do grupo';

  @override
  String get restriction_group_timer_picker_dialog_info => 'Defina um limite diário para este grupo. Dado que o seu limite seja atingido, todos os aplicativos desse grupo serão pausados até a meia-noite.';
  ...
  @override
  String get emergency_started_snack_alert => 'O bloqueador de apps está em pausa e continuará bloqueando por 5 minutos.';

  @override
  String get emergency_already_active_snack_alert => 'O bloqueador de aplicativos está pausado ou inativo. Se as notificações estiverem ativadas, você receberá atualizações sobre o tempo restante.';

  @override
  String get emergency_no_pass_left_snack_alert => 'Você usou todos os seus passes de emergência. Os aplicativos bloqueados permanecerão bloqueados até a meia-noite ou até a sessão de foco ativo terminar.';
  ...
  @override
  String get internet_access_tile_subtitle => 'Desative para bloquear a internet do app.';
  ...
  @override
  String get go_to_app_settings_tile_title => 'Vá para Configurações de aplicativo';
  ...
  @override
  String get amoled_dark_tile_subtitle => 'Use cor preta pura para o tema escuro.';

  @override
  String get dynamic_colors_tile_title => 'Cores dinâmicas';

  @override
  String get dynamic_colors_tile_subtitle => 'Use as cores do dispositivo, se suportado.';
  ...
  @override
  String get import_db_tile_subtitle => 'Importar o banco de dados de um arquivo.';

  @override
  String get export_db_tile_title => 'Exportar banco de dados';

  @override
  String get export_db_tile_subtitle => 'Exportar o banco de dados de um arquivo.';

  @override
  String get crash_logs_heading => 'Relatório de erros';

  @override
  String get crash_logs_info => 'Se você encontrar algum problema, pode reportá-lo no GitHub com o arquivo de log. O arquivo incluirá detalhes como o fabricante, modelo, versão do Android, versão do SDK e registros de falha. Estas informações nos ajuda a identificar e a resolver o problema de forma eficaz.';
  ...
  @override
  String get crash_logs_clear_tile_subtitle => 'Apagar todos os registros de erro do banco de dados.';

  @override
  String get crash_logs_clear_dialog_info => 'Tem certeza de que deseja limpar todos os registros de erro do banco de dados?';

  @override
  String get crash_logs_clear_dialog_button_clear_anyway => 'Limpar mesmo assim';
  ...
  @override
  String get redirected_to_github_subtitle => 'Você vai ser redirecionado para o GitHub.';
