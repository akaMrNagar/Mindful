...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get permission_sheet_privacy_info => 'Mindful jest w 100% bezpieczny i działa offline. Nie zbieramy ani nie przechowujemy żadnych danych osobowych.';
  ...
  @override
  String get permission_grant_step_two => '2. Wybierz Mindful na następnym ekranie.';

  @override
  String get permission_grant_step_three => '3. Kliknij i włącz przełącznik tak jak poniżej.';
  ...
  @override
  String get permission_alarms_info => 'Proszę udzielić pozwolenia na ustawianie alarmów i przypomnień. Dzięki temu Mindful będzie mógł rozpocząć Twój harmonogram snu na czas i resetować timery aplikacji codziennie o północy, co pomoże Ci utrzymać się na właściwej drodze.';

  @override
  String get permission_alarms_device_tile_label => 'Zezwalaj na ustawianie alarmów i przypomnień';

  @override
  String get permission_usage_title => 'Dostęp do danych o użyciu';

  @override
  String get permission_usage_info => 'Proszę udzielić pozwolenia na dostęp do danych o użyciu. Pozwoli to Mindful monitorować użytkowanie aplikacji i zarządzać dostępem do niektórych aplikacji, zapewniając bardziej skoncentrowane i kontrolowane środowisko cyfrowe.';

  @override
  String get permission_usage_device_tile_label => 'Zezwalaj na dostęp do danych o użyciu';

  @override
  String get permission_overlay_title => 'Wyświetl nakładkę';

  @override
  String get permission_overlay_info => 'Proszę udzielić pozwolenia na wyświetlanie nakładki. Umożliwi to Mindful wyświetlanie nakładki po otwarciu wstrzymanej aplikacji, co pomoże Ci zachować koncentrację i utrzymać harmonogram.';

  @override
  String get permission_overlay_device_tile_label => 'Zezwalaj na wyświetlanie nad innymi aplikacjami';

  @override
  String get permission_accessibility_title => 'Dostępność';

  @override
  String get permission_accessibility_info => 'Proszę udzielić zezwolenia na dostępność. Pozwoli to Mindful ograniczyć dostęp do krótkich treści wideo (np. Reels, Shorts) w aplikacjach mediów społecznościowych i przeglądarkach oraz filtrować nieodpowiednie witryny.';

  @override
  String get permission_accessibility_required => 'Pamiętaj, że aby skutecznie blokować krótkie treści i strony internetowe, wymagane jest pozwolenie na dostępność.';

  @override
  String get permission_accessibility_device_tile_label => 'Używaj Mindful';

  @override
  String get permission_dnd_title => 'Nie przeszkadzać';

  @override
  String get permission_dnd_info => 'Proszę udzielić dostępu do trybu \"Nie przeszkadzać\". Pozwoli to na uruchomienie i zatrzymanie trybu \"Nie przeszkadzać\" podczas snu.';

  @override
  String get permission_dnd_tile_title => 'Uruchom DND';

  @override
  String get permission_dnd_tile_subtitle => 'Włącz również tryb Nie przeszkadzać.';

  @override
  String get permission_battery_optimization_tile_title => 'Ignoruj Optymalizację Baterii';

  @override
  String get permission_battery_optimization_status_enabled => 'Są już wyłączone';

  @override
  String get permission_battery_optimization_status_disabled => 'Wyłącz ograniczenia działania aplikacji w tle';

  @override
  String get permission_battery_optimization_allow_info => 'Pozwól na \'Ignorowanie optymalizacji baterii\' automatycznie przydzieli uprawnienia \'Alarmy & Przypomnienia\' na niektórych urządzeniach.';

  @override
  String get permission_vpn_title => 'Utwórz sieć VPN';

  @override
  String get permission_vpn_info => 'Proszę przyznać uprawnienia do tworzenia połączenia wirtualnej sieci prywatnej (VPN). Umożliwi to Mindful ograniczenie dostępu do internetu dla wyznaczonych aplikacji poprzez tworzenie lokalnych sieci VPN na urządzeniu.';

  @override
  String get permission_admin_title => 'Admin';

  @override
  String get permission_admin_info => 'Uprawnienia administratora są potrzebne tylko do wykonywania podstawowych operacji, aby mieć pewność, że aplikacja działa prawidłowo i jest zabezpieczona przed manipulacją.';
